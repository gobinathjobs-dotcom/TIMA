                ...
                <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12">
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-xs sm:text-base text-gray-300 mb-6 leading-relaxed">
                            1We believe that technology should empower humanity, not just industry. Through our rural innovation labs and educational grants, we are bridging the digital divide.
                        </p>
