...
export function Hero() {
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-44 pb-28 sm:pb-16 md:pb-24 lg:pb-40 flex-1 flex flex-col justify-end max-w-[1920px] mx-auto w-full">
                <motion.h1
